  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-gradient-to-br from-orange-400/10 to-cyan-400/10 rounded-full blur-[120px] animate-blob"></div>
        <div className="absolute bottom-0 right-1/4 w-80 sm:w-[28rem] h-80 sm:h-[28rem] bg-gradient-to-tr from-cyan-400/10 to-orange-400/10 rounded-full blur-[140px] animate-blob delay-700"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {mentors.map((mentor) => (
            <div
              key={mentor.name}
              className="group bg-white/70 dark:bg-white/5 backdrop-blur-md border border-gray-200/20 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-orange-400/10 hover:-translate-y-1"
            >
              {/* === IMAGE === */}
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-t-2xl">
                ...
                />
                {/* Hover overlay like coordinator */}
